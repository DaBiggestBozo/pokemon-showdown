export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	zipzapzoom: {
		...
		baseStats: {hp: 38, atk: 30, def: 41, spa: 15, spd: 41, spe: 75},
		abilities: {0: "Motor Drive", 1: "Run Away"},
		heightm: 0.4,
		weightkg: 17.5,
		color: "Yellow",
		evos: ["Lineyoom"],
	...
	lineyoom: {
		...
		name: "Lineyoom",
		types: ["Normal", "Electric"],
		baseStats: {hp: 78, atk: 90, def: 61, spa: 20, spd: 61, spe: 120},
		abilities: {0: "Motor Drive", 1: "Run Away", H: "Transistor"},
		heightm: 0.5,
		weightkg: 32.5,
		color: "Yellow",
		prevo: "Zipzapzoom",
